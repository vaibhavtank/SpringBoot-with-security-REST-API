...
public class MyUserDetailsService implements UserDetailsService,UserService {
 ...
 @Override
 public com.spring.core.model.User getUserByEmailId(String emailId) {
  return userDao.getUserByEmailId(emailId);
 }

 @Override
 public void update(com.spring.core.model.User user) {
   userDao.update(user);
 }

@Override
public com.spring.core.model.User getByUsername(String username) {
	return userDao.getByUsername(username);
}

@Override
public com.spring.core.model.User getByUserNameOrEmailId(String username, String emailId) {
	return userDao.getByUserNameOrEmailId(username,emailId);
}

@Override
public void save(com.spring.core.model.User user) {
	 userDao.save(user);
}
